...
API_ID = int(environ.get('API_ID', '25775051'))
API_HASH = environ.get('API_HASH', '6ce40ae3238646780a8e8b78350c9ec7')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6281497913').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001416467235')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Spiderman_files')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001967537128'))
